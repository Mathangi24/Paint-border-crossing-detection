...
# The top-left corner of the boundary rectangle
boundary_top_left = (50, 50)
# The bottom-right corner of the boundary rectangle
...
# All pixel values above 127 are set to 255 (white), and all below are set to 0 (black)
